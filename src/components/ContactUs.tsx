    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-300">Tell us about your use case. We'll respond within 1 business day.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-4">
          <a
            href="mailto:tech@rhobots.ai"
            className="group bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-2xl p-4 transition-all duration-300 flex items-start gap-3"
          >
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
              <Mail className="w-5 h-5 text-white" />
            </div>
            <div className="text-left">
              <div className="text-white font-semibold">Email</div>
              <div className="text-gray-300 text-sm">tech@rhobots.ai</div>
              <div className="text-gray-400 text-xs mt-1">Fastest way to reach the team</div>
            </div>
          </a>
          ...
          <a
            ...
            className="group bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-2xl p-4 transition-all duration-300 flex items-start gap-3"
          >
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
              <Phone className="w-5 h-5 text-white" />
            </div>
            <div className="text-left">
              <div className="text-white font-semibold">Phone</div>
              <div className="text-gray-300 text-sm">+91 (704) 200-8497</div>
              <div className="text-gray-400 text-xs mt-1">Mon–Fri, 9am–6pm IST</div>
            </div>
          </a>

          <div className="group bg-white/5 border border-white/10 rounded-2xl p-4 flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500 to-pink-500 flex items-center justify-center shrink-0">
              <MessageSquare className="w-5 h-5 text-white" />
            </div>
            <div className="text-left">
              <div className="text-white font-semibold">Slack/Teams</div>
              <div className="text-gray-300 text-sm">Ask for an invite in your email</div>
              <div className="text-gray-400 text-xs mt-1">We collaborate where you already work</div>
            </div>
          </div>
        </div>

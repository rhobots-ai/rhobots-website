...
const ContactUs: FC<ContactUsProps> = ({ variant = 'section' }) => {
  return (
    <section id="contact" className="relative py-20 lg:py-32 bg-gradient-to-br from-gray-50 to-blue-50 overflow-hidden">
      <div className="absolute inset-0 bg-grid-gray-900/[0.03] bg-[size:50px_50px]"></div>
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12">
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Let's Talk</h2>
        ...
        >
          ...
          >
            ...
            <div className="text-left">
              <div className="text-gray-900 font-semibold text-lg">Email</div>
          ...
          >
            ...
            <div className="text-left">
              <div className="text-gray-900 font-semibold text-lg">Phone</div>
              <div className="text-gray-700">+91 (704) 200-8497</div>
              <div className="text-gray-500 text-sm mt-1">Mon–Fri, 9am–6pm IST</div>
            </div>
          </a>

          <div className="group bg-white border border-gray-200 rounded-2xl p-6 flex items-start gap-4">
            ...
            <div className="text-left">
              <div className="text-gray-900 font-semibold text-lg">Slack/Teams</div>
              <div className="text-gray-700">Ask for an invite in your email</div>
              <div className="text-gray-500 text-sm mt-1">We collaborate where you already work</div>
            </div>
          </div>
        </div>

        <div className="max-w-5xl mx-auto mt-10 text-center text-gray-600 flex items-center justify-center gap-2">

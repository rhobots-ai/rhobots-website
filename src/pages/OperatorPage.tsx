    ...
    <main className="grid-substrate min-h-screen">
        ...
        <div className="z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-end gap-8 md:gap-12">
          <div className="flex-1">
            <div className="inline-block px-3 py-1 bg-primary-fixed/10 border-l-4 border-primary-fixed mb-4 md:mb-6">
              <span className="font-mono text-[10px] sm:text-xs tracking-widest text-primary-fixed uppercase">SYSTEM_STATE: ACTIVE_ORCHESTRATION</span>
            </div>
            <h1 className="font-headline text-4xl sm:text-5xl md:text-8xl font-black tracking-tighter leading-[0.9] uppercase text-white mb-6 md:mb-8">
              ARCHITECTING <br />
          ...
          <div className="w-full md:w-80 flex flex-row md:flex-col gap-px bg-outline-variant/20">
            ...
            <div className="flex-1 md:flex-none bg-surface-container-high p-4 sm:p-6 relative overflow-hidden">
              ...
              <span className="font-mono text-[10px] text-on-surface-variant block mb-2 uppercase tracking-widest hidden sm:block">NEURAL_THROUGHPUT</span>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-10 md:mb-16 gap-4">
          <div>
            ...
            <h2 className="font-headline text-2xl sm:text-3xl md:text-4xl font-black uppercase text-white tracking-tight">PRECISION CAPABILITIES</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
          ...
          <div className="md:col-span-8 group bg-surface-container-high relative p-6 md:p-8 hover:bg-surface-bright transition-colors">
            ...
            <p className="text-on-surface-variant max-w-lg mb-6 md:mb-8 text-sm md:text-base">Complex multi-agent coordination across disparate legacy systems and modern cloud architectures.</p>
          ...
          <div className="md:col-span-4 bg-surface-container-high p-6 md:p-8 hover:bg-surface-bright transition-colors relative">
            ...
            <p className="text-on-surface-variant mb-6 text-sm md:text-base">Autonomous mapping of organizational bottlenecks through real-time telemetry analysis.</p>
          </div>
          {/* Capability 3 */}
          <div className="md:col-span-4 bg-surface-container-high p-6 md:p-8 hover:bg-surface-bright transition-colors relative">
            <div className="absolute left-0 top-0 bottom-0 w-1 bg-outline-variant"></div>
            ...
            <h3 className="font-headline text-xl md:text-2xl font-black text-white mb-4 uppercase">Neural Reasoning</h3>
            <p className="text-on-surface-variant mb-6 text-sm md:text-base">Context-aware decision making leveraging proprietary industrial LLMs for zero-shot task execution.</p>
          </div>
          {/* Capability 4 */}
          <div className="md:col-span-8 bg-surface-container-high p-6 md:p-8 hover:bg-surface-bright transition-colors relative">
            ...
            <p className="text-on-surface-variant max-w-md mb-6 md:mb-8 text-sm md:text-base">Hard-coded compliance rails and immutable audit trails for complete operational oversight.</p>
      ...
      <section className="py-16 md:py-24 bg-surface-container-low border-y border-outline-variant/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            <h2 className="font-headline text-2xl sm:text-3xl md:text-4xl font-black uppercase text-white tracking-tight mb-6 md:mb-8">SYSTEM_TERMINAL_V4.0</h2>
            <div className="space-y-6 md:space-y-8">
              <div className="flex gap-4 sm:gap-6">
                ...
                <div>
                  <h4 className="font-headline text-base sm:text-lg font-bold text-white uppercase mb-2">Low-Code Logic Engine</h4>
              ...
              <div className="flex gap-4 sm:gap-6">
                ...
                <div>
                  <h4 className="font-headline text-base sm:text-lg font-bold text-white uppercase mb-2">Real-Time Telemetry</h4>
      ...
      <section className="py-20 md:py-32 px-4 sm:px-6 text-center bg-surface relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <h2 className="font-headline text-3xl sm:text-5xl md:text-7xl font-black uppercase text-white mb-6 md:mb-8 tracking-tighter">READY FOR <span className="text-primary-fixed">AUTONOMY?</span></h2>
          <p className="text-on-surface-variant mb-8 md:mb-12 text-base sm:text-lg">Shift your operational core from manual intervention to neural orchestration. Deploy RHOBOTS Operator today.</p>

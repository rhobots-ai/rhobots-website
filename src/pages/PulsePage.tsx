    ...
    <main className="flex-grow">
      ...
      <section className="relative pt-16 sm:pt-24 pb-12 sm:pb-16 px-4 sm:px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
          <div className="lg:col-span-8">
            ...
            <h1 className="font-headline text-3xl sm:text-4xl md:text-3xl font-semibold text-on-surface leading-[0.85]">
      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6 bg-primary-fixed flex items-center justify-center text-center">
        <div className="max-w-3xl">
          ...
          <a href="/demo" className="w-full sm:w-auto bg-surface-container-lowest text-on-surface px-8 sm:px-12 py-4 sm:py-5 font-headline font-semibold hover:scale-105 transition-all text-center">
            Schedule a demo
          </a>

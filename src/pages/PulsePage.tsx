...
export default function PulsePage() {
  return (
    <main className="flex-grow">
      <SEO
        title="Pulse — guide contact centre calls in real time"
        description="Pulse listens to every call live, prompts the agent with the next best step, and flags compliance risk in the moment rather than in next month's audit."
        path="/products/pulse"
        jsonLd={[
          organizationSchema(),
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
          <div className="lg:col-span-8">
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <span className="font-label text-[10px] uppercase tracking-[0.18em] text-outline">Pulse</span>
            </div>
            <h1 className="font-headline text-3xl sm:text-4xl md:text-3xl font-semibold text-on-surface leading-[1.1]">
              Guide the call while it is still happening.
            </h1>
            <p className="mt-6 sm:mt-8 text-base sm:text-xl text-on-surface-variant max-w-xl font-body leading-relaxed">
              Pulse listens to every call live, prompts the agent with the next best step, and flags a compliance risk in the moment rather than in next month&rsquo;s audit.
            </p>
            <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a href="#try-pulse-now" className="bg-primary text-on-primary px-6 sm:px-8 py-3 sm:py-4 font-body font-medium text-sm sm:text-base hover:ring-2 hover:ring-primary-fixed/30 transition-all active:scale-95 text-center">
                See Pulse in action
              </a>
              <a href="#how-pulse-works" className="border border-outline-variant text-primary px-6 sm:px-8 py-3 sm:py-4 font-headline font-semibold text-sm sm:text-base hover:bg-surface-container transition-all text-center">
                Learn more
              </a>
            </div>
          </div>
          <div className="lg:col-span-4 bg-surface-container-high p-6 sm:p-8 border-l-4 border-primary-container relative">
            ...
            <div className="space-y-6">
              <div>
                <span className="font-label text-xs text-outline uppercase">Handle time reduction</span>
              ...
              <div className="pt-6 border-t border-outline-variant/20">
                <div>
                  <span className="block font-label text-[10px] text-outline uppercase">Compliance accuracy</span>
                  <span className="font-mono text-lg text-on-surface">99.8%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="try-pulse-now" className="py-16 sm:py-24 px-4 sm:px-6 bg-surface border-t border-outline-variant/10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10 sm:mb-16">
            ...
            <h2 className="font-headline text-2xl sm:text-4xl font-semibold tracking-tight text-on-surface mt-2">Try Pulse now</h2>
            <p className="text-on-surface-variant text-sm mt-2 font-body">Select an industry, speak naturally, and see Pulse in action.</p>
          </div>
          <div className="bg-surface-container-high border border-outline-variant/20 relative">
            <PulseDemoWidget />
          </div>
        </div>
      </section>
      ...
      <section id="how-pulse-works" className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10 sm:mb-16">
            ...
            <h2 className="font-headline text-2xl sm:text-4xl font-semibold tracking-tight text-on-surface mt-2">How Pulse works</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="md:col-span-2 bg-surface-container-high p-6 sm:p-10 hover:bg-surface-bright transition-colors group">
              ...
              <h3 className="text-2xl font-semibold font-headline mb-4 text-on-surface">Live transcription</h3>
            ...
            <div className="bg-surface-container-low p-6 sm:p-10 flex flex-col justify-between border border-outline-variant/10 group">
              <div>
                ...
                <h3 className="text-xl font-semibold font-headline mb-4 text-on-surface">Compliance watch</h3>
            ...
            <div className="bg-surface-container-low p-6 sm:p-10 flex flex-col justify-between border border-outline-variant/10">
              <div>
                ...
                <h3 className="text-xl font-semibold font-headline mb-4 text-on-surface">Sentiment analysis</h3>
                <p className="text-sm text-on-surface-variant leading-relaxed">
            ...
            <div className="md:col-span-4 flex flex-col md:flex-row bg-surface-container relative overflow-hidden min-h-[250px] sm:min-h-[300px]">
              <div className="p-6 sm:p-10 md:w-1/2 z-10">
                <h3 className="text-2xl sm:text-3xl font-semibold font-headline mb-4 text-on-surface">Live agent guidance</h3>
              ...
              <div className="md:w-1/2 relative bg-surface-container-highest opacity-50">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 border-t border-outline-variant/10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 sm:gap-16 items-start">
          <div className="lg:w-1/3">
            <span className="font-label text-outline text-sm uppercase tracking-widest">Validated impact</span>
            <h2 className="text-2xl sm:text-4xl font-semibold font-headline tracking-tight text-on-surface mt-4 leading-tight">Results from enterprise deployments</h2>
          </div>
          <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="p-6 sm:p-8 bg-surface-container-high">
              <div className="font-mono text-on-surface text-3xl sm:text-5xl font-bold mb-2">+18%</div>
              <div className="font-mono text-[10px] text-outline uppercase tracking-widest">Customer Satisfaction Lift</div>
            </div>
            <div className="p-6 sm:p-8 bg-surface-container-high">
              <div className="font-mono text-on-surface text-3xl sm:text-5xl font-bold mb-2">99.8%</div>
      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6 bg-primary-fixed flex items-center justify-center text-center">
        <div className="max-w-3xl">
          <h2 className="text-3xl sm:text-3xl md:text-4xl font-semibold font-headline text-on-primary-fixed mb-6 sm:mb-8 leading-[1.1]">
            Listen to Pulse on one of your own calls.
          </h2>
          <p className="mb-8 sm:mb-12 max-w-xl font-body text-base text-on-primary-fixed leading-relaxed">
            We start with a single queue and a recorded call, so you can judge the guidance before it reaches a live customer.
          </p>
          <a href="/demo" className="inline-block w-full sm:w-auto bg-surface-container-lowest text-on-surface px-8 sm:px-12 py-4 sm:py-5 font-headline font-semibold hover:bg-surface-container transition-colors text-center">
            Request a demo
          </a>
        </div>
      </section>

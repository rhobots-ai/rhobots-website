      ...
      <section className="relative px-6 py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 z-10">
            <div className="inline-flex items-center gap-2 bg-secondary-container text-on-secondary-container px-3 py-1 font-mono text-[10px] tracking-widest uppercase mb-6">
              <span className="w-2 h-2 bg-primary-fixed animate-pulse"></span>
              SIGNAL_MONITORING_ACTIVE
            </div>
            <h1 className="font-headline text-6xl md:text-8xl font-black tracking-tighter text-white uppercase leading-none mb-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-primary-fixed text-on-primary-fixed px-8 py-4 font-mono font-bold tracking-widest hover:glow-bleed transition-all">
                BOOT_PULSE_V4
              </button>
              <button className="border border-outline-variant/20 text-primary-fixed px-8 py-4 font-mono font-bold tracking-widest hover:bg-surface-bright/20 transition-all">
                _VIEW_DOCUMENTATION
              </button>
            </div>
          </div>
      ...
      <section className="px-6 py-20 bg-surface">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col mb-16">
            ...
            <h2 className="font-headline text-4xl font-bold tracking-tight text-white uppercase">Operational Stack</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {/* Precision Transcript */}
            <div className="md:col-span-2 bg-surface-container-high p-8 relative group overflow-hidden">
              <div className="absolute top-0 right-0 p-4 font-mono text-[10px] text-outline-variant">SYSTEM_01</div>
              <span className="material-symbols-outlined text-primary-fixed text-4xl mb-6">description</span>
            ...
            <div className="bg-surface-container p-8 relative overflow-hidden">
              ...
              <span className="material-symbols-outlined text-primary-fixed text-4xl mb-6">verified_user</span>
            ...
            <div className="md:col-span-3 lg:col-span-4 bg-surface-container-highest p-8 flex flex-col md:flex-row items-center gap-12 border-l-4 border-primary-fixed">
              <div className="flex-1">
                ...
                <h3 className="font-headline text-3xl font-black text-white uppercase mb-4">Dynamic Orchestration</h3>
      ...
      <section className="px-6 py-24 border-t border-outline-variant/10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-lg">
            <h2 className="font-headline text-5xl font-black text-white uppercase tracking-tighter mb-4">Validated Impact</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 w-full md:w-auto">
            <div className="text-center p-6 bg-surface-container-high">
              <div className="font-mono text-primary-fixed text-4xl font-bold mb-1">-42%</div>
              <div className="font-mono text-[10px] text-outline text-center uppercase tracking-widest">AHT_Reduction</div>
            </div>
            <div className="text-center p-6 bg-surface-container-high">
              <div className="font-mono text-white text-4xl font-bold mb-1">+18%</div>
              <div className="font-mono text-[10px] text-outline text-center uppercase tracking-widest">CSAT_Retention</div>
            </div>
            <div className="text-center p-6 bg-surface-container-high col-span-2 md:col-span-1">
              <div className="font-mono text-white text-4xl font-bold mb-1">99.8%</div>

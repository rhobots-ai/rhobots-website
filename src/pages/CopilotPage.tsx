        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
          <div className="lg:col-span-8">
            ...
            <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <a href="#development-insights" className="border border-outline-variant text-primary px-6 sm:px-8 py-3 sm:py-4 font-headline font-semibold text-sm sm:text-base hover:bg-surface-container transition-all text-center">
                Development insights
              </a>
              <a href="#ticket-workflow" className="border border-outline-variant text-primary px-6 sm:px-8 py-3 sm:py-4 font-headline font-semibold text-sm sm:text-base hover:bg-surface-container transition-all text-center">
                Ticket workflow
              </a>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 border-t border-outline-variant/10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10 sm:gap-16 items-start">
          <div className="lg:w-1/3">
            <span className="font-label text-outline text-sm uppercase tracking-widest">INTEGRATIONS</span>
            <h2 className="text-2xl sm:text-4xl font-semibold font-headline tracking-tight text-on-surface mt-4 leading-tight">Works with your tools</h2>
          </div>
          <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 opacity-40">
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">GITHUB</span>
            </div>
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">JIRA</span>
            </div>
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">AWS</span>
            </div>
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">K8S</span>
            </div>
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">DOCKER</span>
            </div>
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">SLACK</span>
            </div>
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">VSCODE</span>
            </div>
            <div className="flex items-center justify-center h-12 bg-surface-container p-4">
              <span className="font-headline font-semibold text-xl text-on-surface">PYTHON</span>
            </div>
          </div>
        </div>
      </section>

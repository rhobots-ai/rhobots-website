    ...
    <main className="min-h-screen grid-substrate">
      ...
      <section className="relative px-4 sm:px-6 pt-20 sm:pt-24 pb-12 flex flex-col items-start max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-6 sm:mb-8">
          <span className="font-mono text-[9px] sm:text-[10px] tracking-[0.3em] text-primary-fixed bg-primary-fixed/10 px-3 py-1 border-l-4 border-primary-fixed">CORE_MODULE://SAGE</span>
          <span className="font-mono text-[9px] sm:text-[10px] tracking-[0.3em] text-surface-bright">STATUS: OPERATIONAL</span>
        </div>
        <h1 className="font-headline font-black text-4xl sm:text-6xl md:text-8xl leading-tight tracking-tighter text-white max-w-4xl uppercase mb-4 sm:mb-6">
          Talk to Data.<br />
        ...
        <div className="w-full max-w-5xl bg-surface-container shadow-2xl overflow-hidden relative group">
          <div className="h-10 bg-surface-bright flex items-center px-4 gap-2">
            ...
            <div className="w-3 h-3 bg-surface-container-highest"></div>
            <div className="w-3 h-3 bg-surface-container-highest"></div>
            <span className="font-mono text-[10px] text-on-surface-variant ml-4 tracking-widest uppercase hidden sm:inline">Terminal_V4.2.0</span>
          </div>
          <div className="p-4 sm:p-8 scanline border-l-4 border-primary-fixed">
            <div className="flex gap-2 sm:gap-4 font-mono text-primary-fixed mb-4">
              <span>&gt;</span>
              <span className="text-on-surface text-xs sm:text-base break-words">Analyze the correlation between cloud latency spikes and transactional volume in Snowflake across EU-WEST-1...</span>
            </div>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-8">
          ...
          <div className="md:col-span-8 bg-surface-container-high p-6 sm:p-8 flex flex-col justify-between group overflow-hidden relative">
            ...
            <div>
              <div className="font-mono text-[10px] text-primary-fixed mb-4 sm:mb-6 tracking-widest uppercase">MOD_01 // TEMPORAL ANALYSIS</div>
          ...
          <div className="md:col-span-4 bg-surface-bright p-6 sm:p-8 border-l-4 border-primary-fixed">
            <div className="font-mono text-[10px] text-primary-fixed mb-4 sm:mb-6 tracking-widest uppercase">MOD_02 // SEMANTIC</div>
            <h3 className="font-headline font-bold text-2xl sm:text-3xl text-white uppercase mb-4 tracking-tighter">Vector-Mapped Context</h3>
            <p className="text-on-surface-variant text-sm mb-6 sm:mb-8">Sage doesn't just match keywords. It understands the operational context of your entire schema.</p>
          ...
          <div className="md:col-span-12 bg-surface-container p-6 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 sm:gap-12">
            <div className="max-w-xl text-left">
              <h3 className="font-headline font-black text-2xl sm:text-4xl text-white uppercase tracking-tighter mb-4">Native Data Mesh Integration</h3>
              <p className="text-on-surface-variant text-sm sm:text-base">Seamlessly tether Sage to your existing stack. High-speed drivers for Snowflake, BigQuery, Redshift, and Databricks. Zero-latency synchronization.</p>
            </div>
            <div className="grid grid-cols-2 gap-3 sm:gap-4 w-full md:w-auto">
              ...
              <div className="bg-surface-container-highest px-4 sm:px-8 py-4 sm:py-6 flex items-center justify-center font-headline font-bold text-on-surface-variant text-xs sm:text-base tracking-widest border-b-4 border-surface-bright grayscale hover:grayscale-0 transition-all">S3_LAKE</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-24 items-center">
          <div className="order-2 lg:order-1 relative">
            ...
            <div className="absolute -bottom-6 -right-4 sm:-bottom-8 sm:-right-8 bg-surface-bright p-4 sm:p-6 border-l-4 border-primary-fixed shadow-2xl">
              <div className="font-mono text-primary-fixed text-[10px] sm:text-xs mb-2 tracking-widest">_ENCRYPTION_KEY</div>
              <div className="font-mono text-on-surface text-sm sm:text-lg">RSA_4096_ACTIVE</div>
            </div>
          </div>
          <div className="order-1 lg:order-2">
            <h2 className="font-headline font-black text-3xl sm:text-5xl text-white uppercase tracking-tighter mb-6 sm:mb-8 leading-[0.9]">Military Grade Intelligence Infrastructure.</h2>
            <ul className="space-y-6 sm:space-y-8">
              ...
              <li className="flex gap-4 sm:gap-6">
                ...
                <div>
                  <h4 className="font-headline font-bold text-lg sm:text-xl text-white uppercase tracking-tight mb-2">Role-Based Gatekeeping</h4>
      ...
      <section className="px-4 sm:px-6 py-20 sm:py-32 bg-primary-fixed flex flex-col items-center text-center">
        <h2 className="font-headline font-black text-4xl sm:text-6xl md:text-8xl text-on-primary-fixed uppercase tracking-tighter mb-6 sm:mb-8">Ready to Evolve?</h2>
        <p className="font-body text-on-primary-container text-base sm:text-xl max-w-xl mb-8 sm:mb-12 font-medium">Deploy Sage into your private cloud cluster in under 15 minutes. Stop building dashboards. Start asking questions.</p>

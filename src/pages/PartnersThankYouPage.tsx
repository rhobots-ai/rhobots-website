  ...
  return (
    <main className=" min-h-screen flex items-center">
      ...
      <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 md:px-12 py-24 text-center">
        ...
        <h1 className="font-headline font-semibold text-3xl md:text-3xl text-on-surface mb-6">You're on our radar.</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-outline-variant/20 text-left mb-10">
          {[
            ...
            <div key={s.n} className="bg-surface-container-high p-5">
              ...
              <h3 className="font-headline text-sm font-semibold text-on-surface mt-2">{s.t}</h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="mailto:tech@rhobots.ai" className="px-6 py-3 bg-primary text-on-primary font-body font-medium text-sm transition-all">
            tech@rhobots.ai
          </a>
          <Link to="/" className="px-6 py-3 border border-outline text-on-surface font-body font-medium text-sm hover:bg-surface-container transition-all">
            Back to Rhobots
          </Link>
        </div>
      </div>

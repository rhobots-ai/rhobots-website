    ...
    <main>
      ...
      <section className="py-24 px-8 md:px-24 bg-background border-b border-outline max-w-4xl">
        <div className="space-y-12">
          <div>
            <h2 className="font-headline text-2xl font-semibold text-on-surface mb-6">What Are Cookies</h2>
          ...
          <div>
            <h2 className="font-headline text-2xl font-semibold text-on-surface mb-6">Cookies We Use</h2>
            <div className="space-y-6">
              {[
                ...
                <div key={cookie.name} className="border border-outline p-6">
                  <h3 className="font-headline text-lg font-semibold text-on-surface mb-2">{cookie.name}</h3>
          ...
          <div>
            <h2 className="font-headline text-2xl font-semibold text-on-surface mb-6">Managing Cookies</h2>
            <div className="text-on-surface text-sm leading-relaxed opacity-70 space-y-4">
            ...
            <button
              ...
              className="mt-6 px-5 py-3 bg-primary text-on-primary font-headline font-bold text-xs transition-all"
            >
